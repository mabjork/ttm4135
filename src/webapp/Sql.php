...
class Sql
{
     ...
     */
    static function up() {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, username VARCHAR(50), password VARCHAR(100), email varchar(50),  bio varchar(50), isadmin INTEGER);";
    ...
    static function insertDummyUsers() {
        ...
        $q1 = "INSERT INTO users(username, password, isadmin) VALUES ('admin', '".password_hash('31admin31',PASSWORD_BCRYPT)."', 1)";
...
try {
    ...
    Sql::$pdo = new \PDO('sqlite:/home/gr31/apache/htdocs/site/app.db');
